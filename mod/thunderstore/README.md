...
**Single Click Deposits**: Grain Rot takes your money in instalments: 5 gold a press at the elevator, 20 at
...
**Quicker Grinder & Bigger Coins**: Normally the grinder is limited to dispensing one coin with a max value of 10
...
**Hold-to-Attack**: As it says on the tin. Allows for holding the attack button to attack with
